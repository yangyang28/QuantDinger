...
const locale = {
  ...
  'trading-bot.type.hedge_arb': 'Funding Rate Hedge',
  'trading-bot.type.hedge_arbDesc': 'Long spot + short perpetual to collect positive funding (delta-neutral)',
  'trading-bot.type.hedge_arbHint': 'Set funding thresholds, spot/perp qty, and rebalance params (Binance, OKX, HTX, etc.)',
  'trading-bot.type.htx_earn_hedge': 'HTX Earn Hedge',
  'trading-bot.type.htx_earn_hedgeDesc': '100% flexible earn stake + perp short; pre-redeem near liquidation',
  'trading-bot.type.htx_earn_hedgeHint': 'HTX credentials only; requires spot, swap, and earn API permissions',
  'trading-bot.scene.earnHedge': 'Earn + Short',
  ...
  'trading-bot.scene.funding': 'Funding rate',
  'trading-bot.hedgeArb.configHint': 'Long spot + short perpetual to collect funding; supports Binance, OKX, HTX, Bybit, Bitget, Gate, and similar spot+swap credentials.',
  'trading-bot.hedgeArb.spotQtyPh': 'e.g. 0.001',
  'trading-bot.hedgeArb.spotQtyHint': 'Base asset amount for each spot long entry',
  'trading-bot.hedgeArb.spotQtyReq': 'Spot entry quantity is required',
  'trading-bot.hedgeArb.perpQtyPh': 'e.g. 0.001',
  'trading-bot.hedgeArb.perpQtyHint': 'Base asset amount for each perp short entry (may differ from spot)',
  'trading-bot.hedgeArb.perpQtyReq': 'Perp entry quantity is required',
  ...
  'trading-bot.hedgeArb.entryFundingRateReq': 'Entry funding threshold is required',
  'trading-bot.hedgeArb.exitFundingRate': 'Exit funding threshold',
  'trading-bot.hedgeArb.maxBasisPct': 'Max basis',
  'trading-bot.hedgeArb.rebalanceThresholdPct': 'Rebalance threshold',
  'trading-bot.hedgeArb.tickIntervalSec': 'Check interval (sec)',
  'trading-bot.hedgeArb.tickIntervalSecHint': 'Polling interval for funding / rebalance',
  'trading-bot.hedgeArb.tickIntervalSecReq': 'Check interval is required',
  'trading-bot.hedgeArb.maxHoldHours': 'Max hold (hours)',
  'trading-bot.hedgeArb.maxHoldHoursHint': '0 = unlimited',
  'trading-bot.hedgeArb.bestPriceOrderHint': 'Entries use opponent-price IOC (falls back to market) for faster fills vs resting limits',
  'trading-bot.hedgeArb.exchangeNotSupported': 'This exchange credential is not supported for funding hedge. Use Binance, OKX, HTX, Bybit, Bitget, or Gate.',
  'trading-bot.hedgeArb.riskTitle': 'Hedge risk controls',
  'trading-bot.hedgeArb.riskDesc': 'Dual-leg orchestrator manages exits; set max daily loss only here.',
  'trading-bot.hedgeArb.panelTitle': 'Funding hedge status',
  'trading-bot.hedgeArb.panelHint': 'Spot long + perp short notional alignment from hedge-arb service',
  'trading-bot.hedgeArb.statusFlat': 'Flat',
  'trading-bot.hedgeArb.statusHolding': 'Holding',
  'trading-bot.hedgeArb.statusError': 'Error',
  'trading-bot.hedgeArb.fundingRate': 'Funding rate',
  'trading-bot.hedgeArb.basisPct': 'Basis',
  ...
  'trading-bot.hedgeArb.actionRebalance': 'Rebalance',
  'trading-bot.hedgeArb.actionBacktest': 'Funding backtest',
  'trading-bot.hedgeArb.backtestTitle': 'Funding backtest',
  'trading-bot.hedgeArb.backtestCycles': 'Cycles',
  'trading-bot.hedgeArb.backtestNetPnl': 'Net PnL (USDT)',
  'trading-bot.hedgeArb.enterSuccess': 'Hedge enter submitted',
  'trading-bot.hedgeArb.exitSuccess': 'Hedge exit submitted',
  'trading-bot.hedgeArb.rebalanceSuccess': 'Rebalance submitted',
  'trading-bot.hedgeArb.actionFail': 'Action failed',
  ...
  'trading-bot.htxEarnHedge.tickIntervalSec': 'Tick interval (sec)',
  'trading-bot.htxEarnHedge.exchangeNotSupported': 'This bot requires HTX credentials',
  'trading-bot.htxEarnHedge.marketTypeHint': 'K-line uses perp; orchestrator manages earn + spot + swap',
  'trading-bot.htxEarnHedge.riskTitle': 'Earn hedge risk',
  'trading-bot.htxEarnHedge.riskDesc': 'No stop-loss order; pre-redeem before liquidation, sell spot after liq.',
  'trading-bot.htxEarnHedge.panelTitle': 'HTX Earn Hedge',
  'trading-bot.htxEarnHedge.panelHint': '100% flexible earn + perp short',
  'trading-bot.htxEarnHedge.actionDeploy': 'Deploy',
  'trading-bot.htxEarnHedge.actionEmergencyExit': 'Emergency exit',
  'trading-bot.htxEarnHedge.deploySuccess': 'Deploy submitted',
  'trading-bot.htxEarnHedge.emergencySuccess': 'Emergency exit submitted',
  'trading-bot.htxEarnHedge.fsm': 'FSM',
  'trading-bot.htxEarnHedge.preRedeemed': 'Pre-redeemed',
  'trading-bot.htxEarnHedge.earnQty': 'Earn qty',
  'trading-bot.htxEarnHedge.spotAvail': 'Spot avail',
  'trading-bot.htxEarnHedge.perpQty': 'Perp short',
  'trading-bot.htxEarnHedge.mark': 'Mark',
  'trading-bot.htxEarnHedge.liqPrice': 'Liq price',
  'trading-bot.htxEarnHedge.distToLiq': 'Dist to liq',
  ...
  'trading-bot.grid.bestPriceOrder': 'Best Price (Opponent)',
  ...
  "aiAssetAnalysis.copilot.focusSymbol": "Data context",
  ...
  "aiAssetAnalysis.copilot.selectSymbolFirst": "Choose a symbol in Data context before running this tool.",
  ...
  'profile.exchange.signupMt5Note': 'After opening a TMGM account, install MT5 and bind server/login in Broker Accounts.',
...
const copilotI18nPatch = {
  ...
  "aiAssetAnalysis.copilot.quickTools": "Quick tools",
  "aiAssetAnalysis.copilot.hideQuickTools": "Hide quick tools",
  "aiAssetAnalysis.copilot.selectSymbolFirst": "Select a symbol in Data Context first.",
  "aiAssetAnalysis.copilot.thinking": "Thinking...",
